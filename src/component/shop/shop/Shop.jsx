    ...
    <Container>
      <div className={classes.root}>
        ...
        >
          ...
          >
            {/* eslint-disable-next-line react/jsx-props-no-spreading */}
            <Tab label="Bütün Ürünler" {...a11yProps(0)} />
            {/* eslint-disable-next-line react/jsx-props-no-spreading */}
            <Tab label="Kadın" {...a11yProps(1)} />
            {/* eslint-disable-next-line react/jsx-props-no-spreading */}
            <Tab label="Erkek" {...a11yProps(2)} />
            {/* eslint-disable-next-line react/jsx-props-no-spreading */}
            <Tab label="Çanta" {...a11yProps(3)} />
            {/* eslint-disable-next-line react/jsx-props-no-spreading */}
            <Tab label="Ayakkabı" {...a11yProps(4)} />
            {/* eslint-disable-next-line react/jsx-props-no-spreading */}
            <Tab label="Saat" {...a11yProps(5)} />
          </Tabs>
