...
const Cart = () => {
  ...
  const handleRemoveFromCart = (product) => {
    ...
    Toast.fire({
      animation: true,
      title: 'Ürün Sepet Listesinden Kaldırıldı',
    })
  }
    ...
    <Container className={classes.container}>
      <Grid container spacing={4}>
        <Grid item xs={12} className={classes.pageTitle}>
          <h2 className={classes.pageTitleText}>Sepet</h2>
        </Grid>
        {currentProducts.length > 0 ? (
          <>
            ...
            <Grid item xs={12} sm={6} md={5} className={classes.cartTotalBox}>
              <h5 style={{ fontSize: '35px', margin: '10px' }}>Sepet Toplam</h5>
              <div className={classes.cartTotalInfo}>
                <p>
                  Ara toplam: <span>{total} TL</span>
                </p>
                <p>
                  Ürün İndirimleri: <span style={{ color: 'red' }}>0 TL</span>
                </p>
              </div>
          ...
          <Grid item xs={12} className={classes.EmptySection}>
            ...
            />
            <p style={{ fontSize: '25px', marginTop: '50px' }}>Sepet Boş</p>
            <Link to="/shop">
